...
export default function HeaderShow(props) {


    return (
        <header className="sticky top-0 z-10 flex justify-between px-6 py-3 space-x-6 bg-white border-b border-gray-200">
            {/* User Profile */}
            <Link
            ...
            >
                <div className="relative rounded-lg bg-white border-text-unselected border-[2px] border-solid box-border w-full overflow-hidden flex flex-row items-start justify-start p-1 gap-2.5 text-left text-sm text-gray-mid-description font-medium-subtitle">
                    <img
                        className="relative w-5 h-4 overflow-hidden shrink-0"
                        alt=""
                        src={arrowLeft}
                    />
                    <div
